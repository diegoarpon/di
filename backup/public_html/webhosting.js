var Dinamica = (function () {
  ...
  function cargarHeader() {
    fetch("https://wsapps.donweb.com/items/info_general?fields[]=*", {
      ...
      .then((data) => {
        ...
        footerElement.innerHTML = converter.makeHtml(
          header.footer_texto_donweb,
        );
      })
  ...
  function cargarProductoDestacado() {
    fetch("https://wsapps.donweb.com/items/producto_destacado?fields[]=*", {
      ...
      .then((data) => {
        ...
        document.querySelector("#producto-destacado .titulo-xm").textContent =
          producto.bajada;
        document.querySelector("#producto-destacado .titulo-l").textContent =
          producto.titulo;
        document.querySelector("#producto-destacado .bajada-m").textContent =
          producto.parrafo;
        ...
        boton.setAttribute(
          "onclick",
          `window.open('${producto.boton_enlace}', '_blank')`,
        );
        ...
        imagen.src =
          "https://wsapps.donweb.com/assets/" +
          producto.imagen +
          "?fit=outside";
      })
      .catch((error) =>
  ...
  function cargarFooter() {
    fetch("https://wsapps.donweb.com/items/footer?fields[]=*", {
      ...
      .then((response) => response.json())
      .then((data) => {
        const sitiosOficialesContainer =
          document.getElementById("sitios-oficiales");
        const utilizanDonWebContainer =
          document.getElementById("utilizan-donweb");

        sitiosOficialesContainer
          .querySelectorAll("a")
          .forEach((el) => el.remove());
        utilizanDonWebContainer
          .querySelectorAll("a")
          .forEach((el) => el.remove());
